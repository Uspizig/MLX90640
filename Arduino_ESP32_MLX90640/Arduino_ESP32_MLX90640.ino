...
Arduino_ST7789 tft = Arduino_ST7789(TFT_DC, TFT_RST, TFT_MOSI, TFT_CLK, TFT_CS);
...
void setup()
   {
    ...
    tft.fillRect(0, 0, 319, 13, tft.color565(5, 0, 10));
    tft.setCursor(100, 3);
    tft.setTextSize(1);
    tft.setTextColor(ILI9341_YELLOW, tft.color565(5, 0, 10));
    //tft.setTextColor(ILI9341_YELLOW, tft.color565(255, 0, 10));
    tft.print("Thermographie - Uli");    
/*
...
*/
    tft.drawLine(290, 210 - 0, 298, 210 - 0, tft.color565(255, 255, 255));
    tft.drawLine(290, 210 - 30, 298, 210 - 30, tft.color565(255, 255, 255));
    tft.drawLine(290, 210 - 60, 298, 210 - 60, tft.color565(255, 255, 255));
    tft.drawLine(290, 210 - 90, 298, 210 - 90, tft.color565(255, 255, 255));
    tft.drawLine(290, 210 - 120, 298, 210 - 120, tft.color565(255, 255, 255));
    tft.drawLine(290, 210 - 150, 298, 210 - 150, tft.color565(255, 255, 255));
    tft.drawLine(290, 210 - 180, 298, 210 - 180, tft.color565(255, 255, 255));

    tft.setCursor(80, 220);
    tft.setTextColor(WHITE, tft.color565(0, 0, 0));
    tft.print("T+ = ");    
    ...
    for (i = 0; i < 181; i++)
       {
        ...
        tft.drawLine(310, 210 - i, 320, 210 - i, tft.color565(R_colour, G_colour, B_colour));
       } 
